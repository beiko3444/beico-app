...
async function run() {
    ...
    // Test vendor item info using seller_api
    const vendorItemId = "92503428728"; // This is one of the option IDs shown in screenshot
    const path = `/v2/providers/seller_api/apis/api/v1/marketplace/vendor-items/${vendorItemId}`;
