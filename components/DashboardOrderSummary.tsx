        ...
        <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden mb-8 animate-in fade-in slide-in-from-top-4 duration-700">
            ...
            <div className="bg-gray-50/50 p-6 border-b border-gray-100 flex justify-between items-center">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl font-black text-gray-900">주문 관리 현황 (Order Overview)</h2>
                        <p className="text-xs text-gray-500 font-medium mt-0.5">실시간 주문 상태 및 최근 내역 요약</p>
                    </div>
                </div>
                <Link
                    href="/admin/orders"
                    className="text-[11px] font-black bg-white border border-gray-200 px-4 py-2 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all text-gray-500 flex items-center gap-2 group"
                >
                    전체 주문 관리 이동
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
                ...
                <div className="lg:col-span-4 p-6 grid grid-cols-2 gap-4">
                    <Link href="/admin/orders" className="bg-orange-50/50 p-5 rounded-2xl border border-orange-100 hover:shadow-md hover:scale-[1.02] transition-all group flex flex-col justify-between h-32 relative overflow-hidden">
                    ...
                    <Link href="/admin/orders" className="bg-blue-50/50 p-5 rounded-2xl border border-blue-100 hover:shadow-md hover:scale-[1.02] transition-all group flex flex-col justify-between h-32 relative overflow-hidden">
                    ...
                    <Link href="/admin/orders?type=tracking" className="bg-purple-50/50 p-5 rounded-2xl border border-purple-100 hover:shadow-md hover:scale-[1.02] transition-all group flex flex-col justify-between h-32 relative overflow-hidden">
                    ...
                    <div className="bg-gray-50/50 p-5 rounded-2xl border border-gray-100 flex flex-col justify-between h-32">
                        <span className="text-xs font-black text-gray-400 uppercase tracking-widest">완료 (Completed)</span>
                        <div className="flex items-end gap-2">
                            <span className="text-4xl font-black text-gray-600 leading-none">{completedCount}</span>
                            <span className="text-xs font-bold text-gray-400 mb-1">건</span>
                        </div>
                    </div>
                </div>
