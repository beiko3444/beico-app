...
assert.match(orderInterfaceSource, /data-partner-sale-status/)
assert.match(orderInterfaceSource, /soldOut: '품절'/)
assert.match(orderInterfaceSource, /soldOutSub: '주문 불가'/)
assert.match(orderInterfaceSource, /soldOutNotice/)
assert.doesNotMatch(orderInterfaceSource, /grayscale opacity-40/)
