...
assert.match(productTable, /LazyBarcodeCell/)
assert.match(productTable, /IntersectionObserver/)
...
assert.match(productTable, /ProductPaginationControls/)
assert.match(productTable, /ArrowLeft/)
assert.match(productTable, /ArrowRight/)
assert.match(productTable, /pageSize/)
...
assert.match(productsPage, /take: pageSize/)
assert.match(productsPage, /skip: \(page - 1\) \* pageSize/)
