...
export default function AdminOrderCard({ order }: { order: any }) {
    ...
    const formattedDate = `${year}-${month}-${day} ${hour}:${minute} ${ampm}`
        ...
        <div className="bg-[#f4f5f7] rounded-[2rem] w-full max-w-[500px] mx-auto p-4 md:p-6 mb-6">
            ...
            <div className="bg-white rounded-[1.2rem] p-5 shadow-sm mb-6">
                ...
                <div className="space-y-3 p-1">
                    ...
                    <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-400 w-24 shrink-0">Delivery</span>
            ...
            <div className="mb-6">
                <h3 className="text-[17px] font-black text-gray-800 mb-3 ml-1">Shipment Info</h3>
                <OrderActions order={order} />
            </div>

            <div className="mb-6">
                <h3 className="text-[17px] font-black text-gray-800 mb-3 ml-1">Product List</h3>
                            ...
                            <div key={item.id} className="bg-white rounded-[1.2rem] p-4 shadow-sm flex flex-col">
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex-1 min-w-0 flex flex-col justify-between py-0.5">
                                        ...
                                        <div className="grid grid-cols-2 gap-y-2 gap-x-2 w-full text-[11px] pr-2">
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-gray-400">Supply Price</span>
                                ...
                                <div className="flex justify-between items-end pt-3 mt-3">
                                    <div className="text-[11px] text-gray-400 w-full flex justify-between items-center pr-2">
                                        <span>VAT: <strong className="font-bold text-gray-900">{vat.toLocaleString()}</strong></span>
                    ...
                    {shippingFee > 0 && (
                        <div className="bg-gray-50 border border-gray-100 rounded-[1.2rem] p-4 flex gap-4 items-center">
                            <div className="w-14 h-14 bg-gray-200 rounded-xl flex flex-col justify-center items-center text-gray-500 shrink-0">
                                ...
                                <span className="text-[8px] font-bold">Shipping</span>
                            </div>
                            <div className="flex-1 flex justify-between items-center">
                                <div className="flex flex-col">
                                    <span className="font-black text-[15px] text-gray-900">Shipping Fee</span>
                                    <span className="text-[11px] text-gray-400 font-medium">Qty: 1</span>
                                </div>
                                <div className="flex flex-col items-end">
                                    <span className="font-black text-[15px] text-gray-900">{shippingFee.toLocaleString()}</span>
                                    <span className="text-[10px] text-gray-400 mt-0.5">VAT: {shippingVat.toLocaleString()}</span>
                                </div>
                            </div>
                        </div>
                    )}
            ...
            <div className="border-t border-gray-200 pt-4 flex justify-between items-end px-1 mt-6">
                <div className="flex flex-col gap-1 w-full relative">
                    <div className="flex items-center gap-4 text-[11px] font-bold text-gray-500">
                        <span>Supply: {grandSupply.toLocaleString()}원</span>
                        <span>VAT: {grandVat.toLocaleString()}원</span>
                    </div>
                    <span className="text-[12px] font-black tracking-widest text-[#424853] mt-2">TOTAL AMOUNT</span>
                </div>
                <div className="flex flex-col items-end shrink-0">
                    <span className="text-[11px] font-bold text-gray-500 mb-0.5">Qty: {totalQuantity.toLocaleString()}</span>
