                        ...
                        <div className="flex items-start justify-between">
                            <div>
                                ...
                                <div className="flex items-baseline gap-3 mt-1.5 flex-wrap">
                                    <h2 className="text-[24px] font-black text-gray-900 dark:text-white tracking-tight flex items-baseline gap-1.5">
                                        <span className="text-gray-300 dark:text-gray-500 font-medium text-[20px]">#</span>{orderNumber}
                                    </h2>
                                    <span className="text-[20px] font-bold text-gray-700 dark:text-gray-200">{partnerName}</span>
                                </div>
                                <div className="flex items-center gap-1.5 mt-1 text-[11px] text-gray-500 dark:text-gray-400 font-medium">
                ...
                <Section title={`주문 상품 (총 ${totalQuantity.toLocaleString()}개)`} icon={<Package size={14} className="text-gray-400 dark:text-gray-500" />}>
                    <div className="flex flex-col relative z-10">
                        {order.items.map((item: any) => {
                            ...
                            return (
                                <div key={item.id} className="flex gap-4 py-3 border-b border-gray-100 dark:border-[#2a2a2a] last:border-b-0">
                                    {/* 상품 이미지 */}
                                    <div className="w-14 h-14 rounded-xl bg-gray-50 dark:bg-[#1a1a1a] shrink-0 overflow-hidden border border-gray-100 dark:border-[#2a2a2a] flex items-center justify-center">
                                    ...
                                    <div className="flex-1 min-w-0 flex flex-col justify-center">
                                        <button
                                            ...
                                            className="flex items-center gap-1.5 text-[14px] font-bold text-gray-900 dark:text-white hover:text-orange-500 transition-colors text-left w-full"
                                        >
                                        ...
                                        <div className="mt-1.5 flex items-center gap-2">
                                            <span className="inline-flex items-center justify-center bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400 text-[11px] font-black px-2 py-0.5 rounded-md border border-orange-100 dark:border-orange-800">
                                    ...
                                    <div className="text-right shrink-0 self-center">
                                        <div className="text-[14px] font-black text-gray-900 dark:text-white">{lineTotal.toLocaleString()}<span className="text-[10px] text-gray-500 dark:text-gray-400 font-medium ml-0.5">원</span></div>
                                        <div className="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5">+ VAT 포함</div>
                                    </div>
                                </div>
                            )
                        })}
